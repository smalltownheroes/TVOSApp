...
//  TVOSApp
//
//  Created by patrick debois on 08/12/15.
//  Copyright © 2015 patrick debois. All rights reserved.
//
...
class AppDelegate: UIResponder, UIApplicationDelegate, TVApplicationControllerDelegate {
    ...
    static let TVBaseURL = "http://localhost:8080/dist/"
    ...
    func appController(appController: TVApplicationController, evaluateAppJavaScriptInContext jsContext: JSContext){
        ...
        // This a trick to reload the app on JS error so livereload keeps on working even with JS errors in the webpack file
